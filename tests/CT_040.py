...
# Entrada com todos os campos preenchidos corretamente no “advanced search”
...
def CT_040():
    try:
        ...
        print('CT_040: ✅ - Entrada com todos os campos preenchidos corretamente no “advanced search”')
