...
# Entrada com uma palavra-chave NÃO existente no menu de mensagens.
def CT_034():
    try:
        ...
        keyWord = 'Palavra não cadastrada'
        ...
        print('CT_034: ✅ - Entrada com uma palavra-chave NÃO existente no menu de mensagens.')
